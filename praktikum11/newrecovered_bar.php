...
for($negara = 1;$negara < 11;$negara++) {
	$query = mysqli_query($koneksi,"SELECT sum(sembuhbaru) as sembuhbaru FROM tb_covid WHERE ID='$negara'");
	$row = $query->fetch_array();
	$sembuhbaru[] = $row['sembuhbaru'];
}
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <h1><center>Covid Bar Chart : New Recovered</center></h1>
